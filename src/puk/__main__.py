...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--mode", choices=["plain", "fancy"], default="fancy", help="Rendering mode")
...
def main() -> None:
    ...
    config = PukConfig(mode=args.mode, model=args.model, workspace=args.workspace)
    try:
